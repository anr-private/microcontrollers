...
class QwiicSoilMoistureSensor(object):
    ...
    def __init__(self, address=None, i2c_driver=None):
        ...
        print(f"QwiicSoilMoistureSensor.init@75  address 0x{self.address:02X}")
        print(f"QwiicSoilMoistureSensor.init@75  device_name {self.device_name}")
        print(f"QwiicSoilMoistureSensor.init@75  i2c driver {self._i2c}")

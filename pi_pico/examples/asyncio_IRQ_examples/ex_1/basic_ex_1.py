# basic_ex_1.py
#
# See basic_ex_1_details.txt
#
# Uses a list as a data_queue to pass data from IRQ handler to 'main'
...
def irq_handler(pin):
    ...
    # String form ex: 'Pin(5, mode=Pin.OUT)'
    #                 'Pin(6, mode=Pin.IN, pull=Pin.PULL_UP)'
    # So this code only works if the pin number is >=10
    # BUT the code uses Pins 0,1,2
...
# NEED TO FIX the pin numbers
# NEED TO FIX the IRQ_FALLING as needed

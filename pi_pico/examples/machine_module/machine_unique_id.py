...
def show_machine_id():
    ...
    id_a226 = hex_stg[-4:]
    print(f"  is decoded hex_stg == '77bb8ee1849fa226'?  {matches_a226}   id_a226 is '{id_a226}'")

    matches_ae91 = hex_stg == 'f5cb56b9936fae91'
    id_a391 = hex_stg[-4:]
    print(f"  is decoded hex_stg == 'f5cb56b9936fae91'?  {matches_ae91}   id_a391 is '{id_a391}'")
